...
def load_filtered_voc_instances(
     dirname: str, split: str, classnames: str
):
    """
...
def load_voc_instances_wocls(dirname: str, split: str, class_names: Union[List[str], Tuple[str, ...]]):
