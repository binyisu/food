...
from food.modeling import build_model
from food.engine.hooks import EvalHookDeFRCN
from food.checkpoint import DetectionCheckpointer
from food.solver import build_lr_scheduler, build_optimizer
from food.evaluation import DatasetEvaluator, inference_on_dataset, print_csv_format, verify_results
from food.dataloader import MetadataCatalog, build_detection_test_loader, build_detection_train_loader
...
def default_setup(cfg, args):
    ...
    setup_logger(output_dir, distributed_rank=rank, name="food")
