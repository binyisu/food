...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='voc', choices=['voc', 'voc_coco'])
    parser.add_argument('--src-path', type=str, default='/home/subinyi/Users/FSOSOD/DeFRCN-main/output/voc10-5-5/defrcn_det_r101_base1_8_classes/model_final.pth', help='Path to the main checkpoint')
    parser.add_argument('--save-dir', type=str, default='/home/subinyi/Users/FSOSOD/DeFRCN-main/output/voc10-5-5/defrcn_det_r101_base1_8_classes/', help='Save directory')
    parser.add_argument('--method', default='remove', choices=['remove', 'randinit'],
